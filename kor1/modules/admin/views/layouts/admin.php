...
<li><a href="#">Обращения</a>
               		                    ...
               		                    <ul>
                                        <li><a href="<?=\yii\helpers\Url::to(['posts/index']) ?>">Список Обращений</a></li>
                                        <li><a href="<?=\yii\helpers\Url::to(['posts/create']) ?>">Добавить Обращение</a></li>
                                    </ul>
                                </li>


<li><a href="<?=\yii\helpers\Url::to(['profile/index']) ?>">Профиль</a> </li>
