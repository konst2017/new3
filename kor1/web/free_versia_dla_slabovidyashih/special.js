...
if (spec == 'y')
{
  ...
  inputTag.setAttribute("style", "position:relative; z-index:9999; top:0%;padding-right:20%;width:1%;font-size:20px; left:3%; margin: 0px;padding:0px; border: 1px black outset; font-weight:bold; background: white no-repeat; background-size:white; width:0.00000000px; height:0.0000000px; " );
 inputTag.value="";
